...
It tests the calculate_and_print function across various scenarios.
"""
...
@pytest.mark.parametrize("a_string, b_string, operation_string, expected_string", [
    ...
    ("1", "0", 'divide', "Cannot divide by zero"),  # Adjust for the actual error message
...
def test_calculate_and_print(a_string, b_string, operation_string, expected_string, capsys):
    """
    Tests the calculate_and_print function with various inputs and operations.
    Verifies if the output matches the expected string for each scenario.
    """
